...
public class CrateJDBCConnectionTest extends CrateJDBCIntegrationTest {
    ...
    public void testConnectionWithCustomSchema() throws Exception {
        try (Connection conn = DriverManager.getConnection("crate://" + hostAndPort + "/")) {
            conn.setSchema("foo");
            ...
            Connection barConnection = DriverManager.getConnection("crate://" + hostAndPort + "/");
            conn.setSchema("bar");
    ...
    public void testConnectionWithCustomSchemaPrepareStatement() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:crate://" + hostAndPort + "/")) {
...
//            assertThat(resultSet.next(), is(false));
    ...
    public void testGetSchemas() throws Exception {
        try (Connection conn = DriverManager.getConnection(hostAndPort)) {
